...
const abi = [
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_intialSupply", type: "uint256" },
    ],
  ...
  {
    inputs: [],
    name: "Amount_Should_Be_Greater_Than_Zero",
    type: "error",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newTokenValue", type: "uint256" },
    ],
    name: "setTokenValue",
    outputs: [],
    stateMutability: "nonpayable",
