...
export default function PostToTwitterModal({ item, isVisible, setIsVisible }) {
  ...
  return (
    <Modal
      title="Would you like to share this with you friends?"
      okText={
        isLoading ? (
          <div role="status">
            <svg
    ...
    >
      ...
      >
        Tweet your previous order details and experience to the world!
        <div className="mt-4">Tweet and win 2 Supercoin!</div>
      </div>
    </Modal>
  );
}
